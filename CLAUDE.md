...
### 쿠팡 파트너스 광고 (2026-06-27 확립)
- **파트너스 정보**: id=970543, trackingCode=AF9787280, template=carousel
- **렌더링 방식**: `<iframe src="coupang-ad.html">` — 절대 동적 script 주입 방식 사용 금지
  ...
  **올바른 패턴** (`coupang-ad.html`):
  ```html
  <!-- coupang-ad.html: 정적 HTML에서 SDK + G 호출 -->
  <script src="https://ads-partners.coupang.com/g.js"></script>
  <script>new PartnersCoupang.G({id:970543, trackingCode:"AF9787280", subId:null, template:"carousel", width:"100%", height:"140"});</script>
  ```

  ```html
  <!-- article.html: iframe으로 삽입 -->
  <iframe class="coupang-mid-ad" src="coupang-ad.html" frameborder="0" scrolling="no"></iframe>
  ```

- **광고 위치**: 기사 본문 중간 (paragraphs 절반 지점) + 본문 하단 — 총 2곳
- **사이드바 광고**: 기존 정적 script 쌍 방식 유지 (별도 iframe 불필요)
- `coupang-mid-ad` CSS: `display:block; width:100%; height:160px; border:1px solid var(--border);`
